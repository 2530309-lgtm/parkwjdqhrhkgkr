...
mbti_data = {
    ...
    'INTP': {
        '특징': '이상주의적이고  유형으로, 예술적 감각이 뛰어납니다. '
               '강한 내면의 가치를 지니고 있으며, 합니다. '
               '창의적이고 독창적인 아이디어와 원리, 인과관계에 관심이 많으며 실체보다는 실체가 품고 있는 가능성에 관심이 많습니다.'
               '지식을 아는 것과는 별개로 그에 대한 감각이나 실용적 활용에 대해선 둔감한 편이다.
를, 수학과 자연과학 분야에서 두각을 나타냅니다.',
